...
func (c *botServiceClient) SendUpdate(ctx context.Context, in *SendUpdateRequest, opts ...grpc.CallOption) (*SendUpdateResponse, error) {
...
func (UnimplementedBotServiceServer) SendUpdate(context.Context, *SendUpdateRequest) (*SendUpdateResponse, error) {
...
func _BotService_SendUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BotServiceServer).SendUpdate(ctx, req.(*SendUpdateRequest))
	}
